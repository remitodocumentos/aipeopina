...
router.post('/resetear-db', authMiddleware.isAuthenticated, async (req, res) => {
    ...
    try {
        ...
        // 2. Crear tablas manualmente (evitando problemas con archivos SQL)
        ...
        `);
        console.log('✅ Preguntas de funcionarios insertadas');
        ...
        `);
        console.log('✅ Secciones administrativas insertadas');
        
        // Preguntas administrativas básicas
        await client.query(`
        ...
        `);
        console.log('✅ Preguntas administrativas básicas insertadas');
